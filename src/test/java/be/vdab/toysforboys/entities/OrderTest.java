...
//		order1 = new Order(LocalDate.of(2019,1,1), LocalDate.of(2019,2,2), LocalDate.of(2019,1,15), "testComment", customer, Status.SHIPPED, 1);
//		nogEensorder1 = new Order(LocalDate.of(2019,1,1), LocalDate.of(2019,2,2), LocalDate.of(2019,1,15), "testComment", customer, Status.SHIPPED, 1);
//		order2 = new Order(LocalDate.of(2019,1,2), LocalDate.of(2019,2,3), LocalDate.of(2019,1,16), "testComment2", customer, Status.SHIPPED, 1);
//	}
//
//
//
